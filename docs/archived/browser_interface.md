...
![Webinterface project page](../archived/img/webinterface_projects.png)
...
![Webinterface data editor front page](../archived/img/webinterface_editor_front.png)

Parameter data can be shown and edited once the user chooses an object and an alternative.

![Webinterface data page](../archived/img/webinterface_data.png)

On the 'Run' page, the user can select and execute scenarios.

![Webinterface run page](../archived/img/webinterface_run.png)
...
![Webinterface results page](../archived/img/webinterface_results.png)
