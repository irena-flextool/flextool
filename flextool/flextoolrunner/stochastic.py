...
class StochasticSolver:
    ...
    def connect_two_timelines(
        ...
        Returns two dicts mapping timestep name to cumulative duration,
    ...
    def find_previous_timestep(
        ...
        previous_timestep = from_active_time_list[real_period][-1].timestep  # last is the default
    ...
    def find_next_timestep(
        ...
        from_start = this_timeline_duration_from_start[period_timestamp[1]]
        next_timestep = from_active_time_list[period_timestamp[0]][-1].timestep  # last is the default
    ...
    def write_timeline_matching_map(
        ...
        for period, lower_active_time in lower_active_time_list.items():
            ...
            default_timestep = upper_timesteps[-1].timestep  # last is the default
        ...
        with open(wf / "solve_data/timeline_matching_map.csv", 'w', newline='') as realfile:
            ...
            for period_timestep, upper_timestep in matching_map.items():
                writer.writerow([period_timestep[0], period_timestep[1], upper_timestep])
    ...
    def create_stochastic_periods(
        ...
        for solve in solves:
            ...
            for period, active_time in active_time_list.items():
                ...
                # Before branching
                for row in info:
                    if row[0] == period and row[2] == active_time[0].timestep and row[3] == 'yes':
                        found += 1
