...
def compute_group_flows(par, s, v, r) -> None:
    ...
    r.nodeGroupDispatch__from_connection_not_in_aggregate__d = annualize_dt_to_d(r.nodeGroupDispatch__from_connection_not_in_aggregate__dt, par.timestep_weight, par.complete_period_share_of_year, step_duration) if not r.nodeGroupDispatch__from_connection_not_in_aggregate__dt.empty else _empty_gp.copy()
    r.nodeGroupDispatch__to_connection_not_in_aggregate__d = annualize_dt_to_d(r.nodeGroupDispatch__to_connection_not_in_aggregate__dt, par.timestep_weight, par.complete_period_share_of_year, step_duration) if not r.nodeGroupDispatch__to_connection_not_in_aggregate__dt.empty else _empty_gp.copy()
    ...
    r.nodeGroupDispatch__from_connection_aggregate__d = annualize_dt_to_d(r.nodeGroupDispatch__from_connection_aggregate__dt, par.timestep_weight, par.complete_period_share_of_year, step_duration) if not r.nodeGroupDispatch__from_connection_aggregate__dt.empty else _empty_gga.copy()
    r.nodeGroupDispatch__to_connection_aggregate__d = annualize_dt_to_d(r.nodeGroupDispatch__to_connection_aggregate__dt, par.timestep_weight, par.complete_period_share_of_year, step_duration) if not r.nodeGroupDispatch__to_connection_aggregate__dt.empty else _empty_gga.copy()
    ...
    if not losses_set.empty and not r.connection_losses_dt.empty:
        ...
        r.nodeGroupDispatch_Internal_connection_losses__d = annualize_dt_to_d(r.nodeGroupDispatch_Internal_connection_losses__dt, par.timestep_weight, par.complete_period_share_of_year, step_duration)
    else:
    ...
    r.nodeGroupDispatch__unit_to_node_not_in_aggregate__d = annualize_dt_to_d(r.nodeGroupDispatch__unit_to_node_not_in_aggregate__dt, par.timestep_weight, par.complete_period_share_of_year, step_duration)
    r.nodeGroupDispatch__node_to_unit_not_in_aggregate__d = annualize_dt_to_d(r.nodeGroupDispatch__node_to_unit_not_in_aggregate__dt, par.timestep_weight, par.complete_period_share_of_year, step_duration)
    ...
    r.nodeGroupDispatch__group_aggregate_Group_to_unit__d = annualize_dt_to_d(r.nodeGroupDispatch__group_aggregate_Group_to_unit__dt, par.timestep_weight, par.complete_period_share_of_year, step_duration)
    r.nodeGroupDispatch__group_aggregate_Unit_to_group__d = annualize_dt_to_d(r.nodeGroupDispatch__group_aggregate_Unit_to_group__dt, par.timestep_weight, par.complete_period_share_of_year, step_duration)
    ...
    r.nodeGroupDispatch_Internal_unit_losses__d = annualize_dt_to_d(r.nodeGroupDispatch_Internal_unit_losses__dt, par.timestep_weight, par.complete_period_share_of_year, step_duration)
