...
def compute_group_flows(par, s, v, r) -> None:
    ...
    r.nodeGroupDispatch__from_connection_aggregate__d = r.nodeGroupDispatch__from_connection_aggregate__dt.mul(step_duration, axis=0).mul(par.timestep_weight, axis=0).groupby('period').sum().div(par.complete_period_share_of_year, axis=0) if not r.nodeGroupDispatch__from_connection_aggregate__dt.empty else _empty_gga.copy()
    r.nodeGroupDispatch__to_connection_aggregate__d = r.nodeGroupDispatch__to_connection_aggregate__dt.mul(step_duration, axis=0).mul(par.timestep_weight, axis=0).groupby('period').sum().div(par.complete_period_share_of_year, axis=0) if not r.nodeGroupDispatch__to_connection_aggregate__dt.empty else _empty_gga.copy()
    ...
    if not losses_set.empty and not r.connection_losses_dt.empty:
        ...
        r.nodeGroupDispatch_Internal_connection_losses__d = r.nodeGroupDispatch_Internal_connection_losses__dt.mul(step_duration, axis=0).mul(par.timestep_weight, axis=0).groupby('period').sum().div(par.complete_period_share_of_year, axis=0)
    else:
    ...
    r.nodeGroupDispatch__unit_to_node_not_in_aggregate__d = r.nodeGroupDispatch__unit_to_node_not_in_aggregate__dt.mul(step_duration, axis=0).mul(par.timestep_weight, axis=0).groupby('period').sum().div(par.complete_period_share_of_year, axis=0)
    r.nodeGroupDispatch__node_to_unit_not_in_aggregate__d = r.nodeGroupDispatch__node_to_unit_not_in_aggregate__dt.mul(step_duration, axis=0).mul(par.timestep_weight, axis=0).groupby('period').sum().div(par.complete_period_share_of_year, axis=0)
    ...
    r.nodeGroupDispatch__group_aggregate_Group_to_unit__d = r.nodeGroupDispatch__group_aggregate_Group_to_unit__dt.mul(step_duration, axis=0).mul(par.timestep_weight, axis=0).groupby('period').sum().div(par.complete_period_share_of_year, axis=0)
    r.nodeGroupDispatch__group_aggregate_Unit_to_group__d = r.nodeGroupDispatch__group_aggregate_Unit_to_group__dt.mul(step_duration, axis=0).mul(par.timestep_weight, axis=0).groupby('period').sum().div(par.complete_period_share_of_year, axis=0)
    ...
    r.nodeGroupDispatch_Internal_unit_losses__d = r.nodeGroupDispatch_Internal_unit_losses__dt.mul(step_duration, axis=0).mul(par.timestep_weight, axis=0).groupby('period').sum().div(par.complete_period_share_of_year, axis=0)
