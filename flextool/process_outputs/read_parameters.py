...
def read_parameters(output_dir):
    ...
    p.entity_pre_existing = pd.read_csv(solve_data_path / 'p_entity_pre_existing.csv', index_col=[0, 1]).astype(float)
    p.process_startup_cost = pd.read_csv(solve_data_path / 'pdProcess_startup_cost.csv', index_col=[0, 1]).astype(float)
    p.entity_fixed_cost = pd.read_csv(solve_data_path / 'ed_fixed_cost.csv', index_col=[0, 1]).astype(float)
    p.entity_lifetime_fixed_cost = pd.read_csv(solve_data_path / 'ed_lifetime_fixed_cost.csv', index_col=[0, 1]).astype(float)
    p.entity_lifetime_fixed_cost_divest = pd.read_csv(solve_data_path / 'ed_lifetime_fixed_cost_divest.csv', index_col=[0, 1]).astype(float)
    ...
    p.entity_annual_discounted = pd.read_csv(solve_data_path / 'ed_entity_annual_discounted.csv', index_col=[0, 1]).astype(float)
    p.entity_annual_divest_discounted = pd.read_csv(solve_data_path / 'ed_entity_annual_divest_discounted.csv', index_col=[0, 1]).astype(float)
    p.inflation_factor_operations_yearly = pd.read_csv(solve_data_path / 'p_inflation_factor_operations_yearly.csv', index_col=[0, 1])['value'].astype(float)
    p.inflation_factor_investment_yearly = pd.read_csv(solve_data_path / 'p_inflation_factor_investment_yearly.csv', index_col=[0, 1])['value'].astype(float)
    p.node_capacity_for_scaling = pd.read_csv(solve_data_path / 'node_capacity_for_scaling.csv', index_col=[0, 1]).astype(float)
    p.group_capacity_for_scaling = pd.read_csv(solve_data_path / 'group_capacity_for_scaling.csv', index_col=[0, 1]).astype(float)
