...
def read_parameters(output_dir):
    ...
    p.process_slope = pd.read_csv(solve_data_path / 'pdtProcess_slope.csv', index_col=[0, 1, 2]).astype(float)
    p.process_section = pd.read_csv(solve_data_path / 'pdtProcess_section.csv', index_col=[0, 1, 2]).astype(float)
