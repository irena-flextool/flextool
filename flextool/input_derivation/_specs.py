...
_ENTITY_SPECS: list[EntitySpec] = [
    ...
    EntitySpec(["flowGroup__unit__node", "flowGroup__connection__node"], "flowGroup,process,node",
...
_PARAMETER_SPECS: list[dict] = [
    ...
    {
        "cl_pars": [("flowGroup", "flow_aggregator")],
        "header": "flowAggregator",
        "filename": "input/flowAggregator.csv",
        "filter_in_value": {"dispatch_plots_only", "both"},
        "no_value": True,
    },
    # --- model parameters ---
    {
    ...
    # --- node parameters ---
    {
        "cl_pars": [("node", "constraint_invested_capacity_coeff")],
        "header": "node,constraint,p_node_constraint_invested_capacity_coeff",
        "filename": "input/p_node_constraint_invested_capacity_coeff.csv",
    },
    {
        "cl_pars": [("node", "constraint_cumulative_pre_built_capacity_coeff")],
        "header": "node,constraint,p_node_constraint_prebuilt_capacity_coeff",
        "filename": "input/p_node_constraint_cumulative_pre_built_capacity_coeff.csv",
    },
    {
        "cl_pars": [("node", "constraint_state_coeff")],
        "header": "node,constraint,p_node_constraint_state_coeff",
        "filename": "input/p_node_constraint_state_coeff.csv",
    },
    {
    ...
    {
        "cl_pars": [("unit__outputNode", "constraint_flow_coeff"),
                    ("unit__inputNode", "constraint_flow_coeff"),
                    ("connection__node", "constraint_flow_coeff")],
        "header": "process,node,constraint,p_process_node_constraint_flow_coeff",
        "filename": "input/p_process_node_constraint_flow_coeff.csv",
        "filter_in_type": ["1d_map"],
    },
    {
        "cl_pars": [("unit", "constraint_invested_capacity_coeff"),
                    ("connection", "constraint_invested_capacity_coeff")],
        "header": "process,constraint,p_process_constraint_invested_capacity_coeff",
        "filename": "input/p_process_constraint_invested_capacity_coeff.csv",
        "filter_in_type": ["1d_map"],
    },
    {
        "cl_pars": [("unit", "constraint_cumulative_pre_built_capacity_coeff"),
                    ("connection", "constraint_cumulative_pre_built_capacity_coeff")],
        "header": "process,constraint,p_process_constraint_prebuilt_capacity_coeff",
    ...
    # --- p_flowgroup (scalars) ---
    # v58 split: the 4 numeric flow-limit params live on the dedicated
    # ``flowGroup`` class (see specs/nodegroup_flowgroup_db_split.md §5.1).
    {
        "cl_pars": [("flowGroup", "groupParam"),
                    ("flowGroup", "max_cumulative_flow"),
                    ("flowGroup", "max_instant_flow"),
                    ("flowGroup", "min_cumulative_flow"),
                    ("flowGroup", "min_instant_flow")],
        "header": "flowGroup,groupParam,p_flowgroup",
        "filename": "input/p_flowgroup.csv",
        "filter_in_type": ["float", "str", "bool"],
        "param_print": True,
    },
    ...
    # --- pdt_flowgroup (time maps) ---
    # v58 split: time-varying flow-limit params on ``flowGroup``.
    {
        "cl_pars": [("flowGroup", "max_cumulative_flow"),
                    ("flowGroup", "max_instant_flow"),
                    ("flowGroup", "min_cumulative_flow"),
                    ("flowGroup", "min_instant_flow")],
        "header": "flowGroup,groupParam,time,pt_flowgroup",
        "filename": "input/pdt_flowgroup.csv",
        "filter_in_type": ["1d_map"],
        "param_print": True,
    },
    ...
    {
        "cl_pars": [("group", "print_indicators")],
    ...
    },
    {
        ...
        "filter_in_value": {"standalone_aggregator_only", "both"},
        "no_value": True,
    },
    {
