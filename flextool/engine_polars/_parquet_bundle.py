...
for _spec in (
    ...
    _v("v_dual_minInvest_period",       ("entity",), has_time=False,
       note="MinInvest-per-period dual; only emitted when minInvest_period set."),
    _v("v_dual_minInvest_total",        ("entity",), has_time=False,
       note="MinInvest-total dual; only emitted when minInvest_total set."),
    _v("v_dual_minCumulative",          ("entity",), has_time=False,
       note="Cumulative-floor dual; only emitted when minCumulative set."),
    _v("v_dual_minInvestGroup_period",     ("group",), has_time=False,
       note="MinInvestGroup-period dual; only emitted when group invest floor set."),
    _v("v_dual_minInvestGroup_total",      ("group",), has_time=False,
       note="MinInvestGroup-total dual; only emitted when group invest floor set."),
    _v("v_dual_minInvestGroup_cumulative", ("group",), has_time=False,
       note="MinInvestGroup-cumulative dual; only emitted when group invest floor set."),
