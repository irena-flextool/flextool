...
Centralises the parent-qualified Provider keys (``"solve_data/<basename>.csv"``,
``"input/<basename>.csv"``, etc.) used by emit_* writers, cascade readers,
...
registration in :func:`_emit_provider_io._emit`.  Every frame now lives
under exactly one Provider key — the parent-qualified form.  Stringly-typed
lookups (``provider.get("solve_data/active_timelines.csv")``) are
...
* The canonical form is ``"<parent>/<basename>.csv"`` (the form
  :func:`_emit_provider_io._provider_key` derives from a workdir Path).
* Constant names are uppercased, underscore-separated, prefixed with
  the parent: ``SOLVE_DATA_ACTIVE_TIMELINES``, ``INPUT_TIMELINE``,
  ``DERIVED_CT_METHOD_OVERRIDES``.
...
This module currently covers the **cross-solve carrier set** and other
high-traffic keys touched by orchestration and the ``_solve_context``
loaders.  The single-use ``solve_data/*`` emit-and-forget keys (most of
...
SOLVE_DATA_FIX_STORAGE_QUANTITY = "solve_data/fix_storage_quantity.csv"
SOLVE_DATA_FIX_STORAGE_PRICE = "solve_data/fix_storage_price.csv"
SOLVE_DATA_FIX_STORAGE_USAGE = "solve_data/fix_storage_usage.csv"
SOLVE_DATA_P_ENTITY_PRE_EXISTING = "solve_data/p_entity_pre_existing.csv"
SOLVE_DATA_P_ENTITY_DIVEST_CUMULATIVE_MAX = (
    "solve_data/p_entity_divest_cumulative_max.csv"
)
SOLVE_DATA_P_ENTITY_INVESTED = "solve_data/p_entity_invested.csv"
SOLVE_DATA_P_ENTITY_DIVESTED = "solve_data/p_entity_divested.csv"
SOLVE_DATA_P_ENTITY_PERIOD_EXISTING_CAPACITY = (
    "solve_data/p_entity_period_existing_capacity.csv"
)
SOLVE_DATA_P_ROLL_CONTINUE_STATE = "solve_data/p_roll_continue_state.csv"
SOLVE_DATA_CO2_CUM_REALIZED_TONNES = "solve_data/co2_cum_realized_tonnes.csv"
SOLVE_DATA_LADDER_CUM_SIM_HOURS = "solve_data/ladder_cum_sim_hours.csv"
SOLVE_DATA_LADDER_CUM_REALIZED_MWH = "solve_data/ladder_cum_realized_mwh.csv"
SOLVE_DATA_ED_HISTORY_REALIZED = "solve_data/ed_history_realized.csv"
SOLVE_DATA_ED_HISTORY_REALIZED_FIRST = "solve_data/ed_history_realized_first.csv"
SOLVE_DATA_EDD_HISTORY = "solve_data/edd_history.csv"
...
CROSS_SOLVE_KEYS: tuple[str, ...] = (
    ...
    SOLVE_DATA_P_ENTITY_PRE_EXISTING,
    SOLVE_DATA_P_ENTITY_DIVEST_CUMULATIVE_MAX,
    ...
    SOLVE_DATA_ED_HISTORY_REALIZED,
    SOLVE_DATA_ED_HISTORY_REALIZED_FIRST,
    SOLVE_DATA_EDD_HISTORY,
)
...
SOLVE_DATA_ACTIVE_TIMELINES = "solve_data/active_timelines.csv"
SOLVE_DATA_INVEST_PERIODS_OF_CURRENT_SOLVE = (
    "solve_data/invest_periods_of_current_solve.csv"
)
SOLVE_DATA_PROCESS_SOURCE_TOSINK = "solve_data/process_source_toSink.csv"
SOLVE_DATA_REGION_COUPLING = "solve_data/region_coupling.csv"
...
INPUT_COMMODITY_LADDER_ANNUAL = "input/commodity_ladder_annual.csv"
INPUT_COMMODITY_LADDER_CUMULATIVE = "input/commodity_ladder_cumulative.csv"
INPUT_CONNECTION_DC_POWER_FLOW = "input/connection_dc_power_flow.csv"
INPUT_GROUP__CO2_METHOD = "input/group__co2_method.csv"
INPUT_NODE_DC_POWER_FLOW = "input/node_dc_power_flow.csv"
INPUT_NODE_REFERENCE_ANGLE = "input/node_reference_angle.csv"
INPUT_P_CONNECTION_SUSCEPTANCE = "input/p_connection_susceptance.csv"
INPUT_PERIODS_AVAILABLE = "input/periods_available.csv"
INPUT_PROCESS_METHOD = "input/process_method.csv"
