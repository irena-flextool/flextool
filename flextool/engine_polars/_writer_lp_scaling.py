...
def write_lp_scaling_params(
    ...
    capacity proxies and their reciprocals.
    """
    ...
    _write_keyed_2(
        solve_data_dir / "_node_cap_unitsize_sum.csv",
    ...
    _write_keyed_2(
        solve_data_dir / "_node_cap_raw.csv",
    ...
    _write_keyed_2(
        solve_data_dir / "_node_cap_pow10.csv",
    ...
    _write_keyed_2(
        solve_data_dir / "node_capacity_for_scaling.csv",
        ("node", "period", "value"), rows_ncfs,
    )
    _write_keyed_2(
        solve_data_dir / "inv_node_cap.csv",
    ...
    _write_keyed_2(
        solve_data_dir / "_group_cap_raw.csv",
    ...
    _write_keyed_2(
        solve_data_dir / "_group_cap_pow10.csv",
    ...
    _write_keyed_2(
        solve_data_dir / "group_capacity_for_scaling.csv",
        ("group", "period", "value"), rows_gcfs,
    )
    _write_keyed_2(
        solve_data_dir / "inv_group_cap.csv",
