...
class TestYearsRepresented10:
    ...
    def run_result(
        ...
        os.chdir(workdir)
        return _run_scenario("y2020_2029_1x10y", test_db_url, test_solver_config_dir, workdir)
...
class TestYearsRepresented5:
    ...
    def run_result(
        ...
        os.chdir(workdir)
        return _run_scenario("y2020_2029_2x5y", test_db_url, test_solver_config_dir, workdir)
...
class TestYearsRepresentedHalf:
    ...
    def run_result(
        ...
        os.chdir(workdir)
        return _run_scenario("coal_half_year", half_year_db_url, test_solver_config_dir, workdir)
...
class TestYearsRepresented2_5:
    ...
    def run_result(
        ...
        os.chdir(workdir)
        return _run_scenario("coal_2_5_year", two_and_half_year_db_url, test_solver_config_dir, workdir)
