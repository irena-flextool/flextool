...
The polar_high analogue lives in :func:`flextool.input.build_handoff_from_solution`
...
polar_high emits at each sub-solve, comparing against flextool's
...
def test_chain_handoff_writers_match_snapshots(scenario_workdir) -> None:
    ...
    This is the polar_high analogue of flextool's
    ...
    that — flextool's writer rounds to 8 sig figs; polar_high carries
