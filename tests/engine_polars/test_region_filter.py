...
class TestDiscovery:
    def test_load_decomposition_method(self) -> None:
        meth = load_decomposition_method(WORK)
        assert meth == {
    ...
    def test_discover_regions(self) -> None:
        regions = discover_regions(WORK)
    ...
    def test_region_membership_lh2(self) -> None:
