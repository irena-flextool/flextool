...
_REQUIRED_PARAM_ATTRS: tuple[str, ...] = (
    ...
    "process_sink_flow_coefficient",
    "process_source_flow_coefficient",
...
def coal_wind_solution():
    ...
    existing capacity.
    """
    fixture = DATA / "work_coal_wind_inertia"
    db = fixture / "tests.sqlite"
    if not db.exists():
        pytest.skip(f"fixture sqlite missing: {db}")
    import tempfile
...
def test_write_outputs_fast_path_emits_all_dirs(tmp_path: Path) -> None:
