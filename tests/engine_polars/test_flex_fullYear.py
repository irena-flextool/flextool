"""flexpy ``fullYear`` parity.  Pure-slack 8760-hour dispatch (no
generators); just confirms the engine handles a year-length timeline."""
...
WORK = Path(__file__).resolve().parent / "data" / "work_fullYear"


def test_fullYear_parity():
