"""flexpy ``wind_battery_invest_lifetime_choice`` parity."""
...
WORK = Path(__file__).resolve().parent / "data" / "work_wind_battery_invest_lifetime_choice"


def test_wind_battery_invest_lifetime_choice_parity():
