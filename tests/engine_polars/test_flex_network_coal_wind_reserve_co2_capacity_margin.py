"""flexpy ``network_coal_wind_reserve_co2_capacity_margin`` parity —
exercises the reserve subsystem (timeseries variant) on top of CO2
pricing and the capacityMargin group-slack feature."""
...
WORK = Path(__file__).resolve().parent / "data" / "work_network_coal_wind_reserve_co2_capacity_margin"
...
def test_network_coal_wind_reserve_co2_capacity_margin_parity():
