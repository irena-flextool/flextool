"""flexpy multi_year_one_solve_battery parity."""
from pathlib import Path
import polars as pl
from flexpy import Problem
from flextool.engine_polars import load_flextool, build_flextool

WORK = Path(__file__).resolve().parent / "data" / "work_multi_year_one_solve_battery"
...
def test_multi_year_one_solve_battery_parity():
