"""flexpy ``network_coal_wind_reserve_n_1`` parity — exercises the
n-1 reserve constraint family (``reserveBalance_up_n_1_eq`` /
...
def test_network_coal_wind_reserve_n_1_parity():
