...
Pre-A6: polar_high was 3.85× higher than flextool (combination of missing
...
# Phase 3d: ``work_2day_stochastic_dispatch_full_storage`` was a renamed
# alias for the canonical ``2_day_stochastic_dispatch`` scenario in the
# stochastics fixture.  The "_full_storage" suffix only distinguished it
# from the no_storage variant on disk; the underlying scenario is the
# same.
SCENARIO = "2_day_stochastic_dispatch"


def test_2day_stochastic_dispatch_full_storage_parity(scenario_workdir):
