...
def test_param_cells_size_bound_on_real_fixture() -> None:
    ...
    data_dir = Path(__file__).resolve().parent / "data" / "work_test_a_lot"
    if not data_dir.exists():
        pytest.skip(f"fixture {data_dir} not present")
