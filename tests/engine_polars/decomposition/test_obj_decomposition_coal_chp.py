...
If a future flexpy patch adds a per-output-flow obj term and forgets
...
WORK = Path(__file__).resolve().parents[1] / "data" / "work_coal_chp"


def test_obj_decomposition_coal_chp():
