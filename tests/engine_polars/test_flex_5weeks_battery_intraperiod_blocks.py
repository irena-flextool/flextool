"""flexpy ``5weeks_battery_intraperiod_blocks`` parity — exercises
intraperiod-block storage handling that ``_cumulative_invest`` does
not cover."""
...
def test_5weeks_battery_intraperiod_blocks_parity():
