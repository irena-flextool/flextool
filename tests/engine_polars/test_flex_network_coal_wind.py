"""flexpy ``network_coal_wind`` parity (multi-node + connection process)."""
...
WORK = Path(__file__).resolve().parent / "data" / "work_network_coal_wind"


def test_network_coal_wind_parity():
