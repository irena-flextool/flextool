"""Stage-2: polar_high ``base`` model on real flextool-generated data
...
def test_base_parity(base_data, work):
    """polar_high's obj must match flextool's recorded v_obj within 1e-6 rel."""
...
def test_base_closed_form(base_data, perturbation):
    """polar_high must agree with the closed-form re-evaluation for any
