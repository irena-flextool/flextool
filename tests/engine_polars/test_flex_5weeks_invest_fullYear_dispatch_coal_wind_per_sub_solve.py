"""polar_high ``5weeks_invest_fullYear_dispatch_coal_wind`` — per-sub-solve parity.
...
def test_5weeks_invest_fullYear_dispatch_per_sub_solve(sub_solve, scenario_workdir):
