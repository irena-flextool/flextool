"""flexpy aggregate_outputs_network_coal_wind_chp parity."""
...
WORK = Path(__file__).resolve().parent / "data" / "work_aggregate_outputs_network_coal_wind_chp"
...
def test_aggregate_outputs_network_coal_wind_chp_parity():
