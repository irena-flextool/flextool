"""flexpy multi_year_one_solve_co2_limit parity."""
...
WORK = Path(__file__).resolve().parent / "data" / "work_multi_year_one_solve_co2_limit"
...
def test_multi_year_one_solve_co2_limit_parity():
