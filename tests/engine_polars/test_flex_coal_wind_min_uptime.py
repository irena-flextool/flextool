"""flexpy ``coal_wind_min_uptime`` parity (linear UC + min uptime)."""
...
WORK = Path(__file__).resolve().parent / "data" / "work_coal_wind_min_uptime"


def test_coal_wind_min_uptime_parity():
