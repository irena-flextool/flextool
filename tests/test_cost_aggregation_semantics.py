...
class TestBaseControl:
    ...
    def csv_dir(
        ...
        return _run_scenario("base", test_db_url, test_solver_config_dir, workdir)
...
class TestRpCostWeightSlackPenalty:
    ...
    def csv_dir(
        ...
        return _run_scenario("base_weighted", test_db_url, test_solver_config_dir, workdir)
...
class TestCapacityMarginPenalty:
    ...
    def csv_dir(
        ...
        return _run_scenario("capacity_margin", test_db_url, test_solver_config_dir, workdir)
...
class TestCoalControl:
    ...
    def csv_dir(
        ...
        return _run_scenario("coal", test_db_url, test_solver_config_dir, workdir)
...
class TestCoalWindInertiaControl:
    ...
    def csv_dir(
        ...
        return _run_scenario("coal_wind_inertia", test_db_url, test_solver_config_dir, workdir)
...
class TestDivestSalvageIncludedInObjective:
    ...
    def csv_dir(
        ...
        return _run_scenario("coal_retire", test_db_url, test_solver_config_dir, workdir)
...
class TestMinLoadEfficiencySectionTerm:
    ...
    def csv_dir(
        ...
        return _run_scenario(
            "coal_min_load_wind", patched_db_url, test_solver_config_dir, workdir,
        )
...
def test_storage_state_reference_price_credit() -> None:
    """Sentinel: the reference-price credit IS now implemented in Python
    at ``flextool/engine_polars/model.py:3406-3428`` (storage-state
    reference-price objective term).  The wiring is exercised by
    ``tests/engine_polars/constraints/test_storage_handoff_wiring.py``
    (Sc B: ``test_storage_handoff_wiring_sc_b_fix_price``) which proves
    the term fires with the correct sign and unitsize scaling.

    Kept as a documentation pointer.  Delete if the wiring test
    is renamed or split.
    """
    pass
