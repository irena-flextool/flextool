...
param potentialVREgen_dt{(p, n) in process_sink, (d, t) in dt : d in period_realized && p in process_VRE} :=
...
for {s in solve_current, (d, t, t_previous) in dtt : d in period_realized}
  {
...
for {n in nodeBalance, s in solve_current, (d, t, t_previous) in dtt : d in period_realized}
  {
